...
Revision ID: b3b2c9c3c29d
Revises: 
Create Date: 2025-08-28 15:58:20.739757
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('DEVELOPER', 'MAINTAINER', 'ADMIN', name='role'), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('status', sa.Enum('RUNNING', 'STOPPED', name='status'), nullable=True),
